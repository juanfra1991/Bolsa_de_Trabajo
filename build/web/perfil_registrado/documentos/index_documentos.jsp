...
<div class="container">
    ...
    <form class="form-horizontal" enctype="multipart/form-data" name="form" role="form" method="POST" action="documentos.jsp">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa-file-pdf-o"></i></div>
                        <input type="file" class="form-control" name="avatar" id="exampleInputFile" aria-describedby="fileHelp" required autofocus multiple>
                    </div>
                </div>
            </div>
        </div>
        <div class="row" align="center" style="padding-top: 1rem">
            <div class="col-md-3"></div>
            <div class="col-md-6">
                <button type="submit" name="fichero" class="btn btn-success"><i class="fa fa-upload"></i> Subir Fichero</button>
            </div>
        </div>
    </form>
</div>
