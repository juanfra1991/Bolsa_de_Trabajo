...
<title>Home Lista Empresas</title>
</head>
<body>
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="index_lista_empresas.jsp">Bolsa de Trabajo</a>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            <h2 class="text-center">Lista Empresas</h2>
            <hr>
        </div>
    </div>
<%
...
StringBuffer built_stmt1=new StringBuffer(); 
{
    ...
    out.println("<div class='table-responsive'>");
        out.println("<table id='dataTable' class='table table-hover'>");
            ...
            sentencia_sql1=sentencia1.executeQuery("select * from sector_profesional where cod_sector="+sentencia_sql.getString(5));
