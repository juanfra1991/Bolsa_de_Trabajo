...
<title>Home Lista Usuarios</title>
</head>
<body>
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	<a class="navbar-brand" href="index_lista_usuarios.jsp">Bolsa de Trabajo</a>
...
StringBuffer built_stmt1=new StringBuffer(); 
{
    ...
    sentencia_sql=sentencia.executeQuery("select email, nombre, apellido, fecha_nacimiento, fecha_registro, cod_sector, if (activo=0,'No','Si') as activo from usuario");            
    ...
    out.println("<div class='table-responsive'>");
		out.println("<table id='dataTable' class='table table-hover'>");
	        ...
	        sentencia_sql1=sentencia1.executeQuery("select * from sector_profesional where cod_sector="+sentencia_sql.getString(6));
		        if (sentencia_sql1.next()) {
		        	out.println("<tr>");
			            ...
			            out.println("<td>"+sentencia_sql.getString(4)+"</td>");
			            out.println("<td>"+sentencia_sql.getString(5)+"</td>");
			            out.println("<td>"+sentencia_sql.getString(7)+"</td>");
			            out.println("<td>"+sentencia_sql1.getString(2)+"</td>");
		        	out.println("</tr>");
		        }
		    }
     	out.println("</tbody>");
