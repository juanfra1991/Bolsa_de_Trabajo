...
{    
    try {
        ...
        built_stmt1.append("select * from sector_profesional where cod_sector='+cod_sector'");
        sentencia_sql= sentencia1.executeQuery(built_stmt1.toString());
        if (!sentencia_sql.next()) {       
            sentencia=conexion.createStatement();
            built_stmt.append("insert into sector_profesional values ('"+cod_sector+"','"+nombre+"')");
...
<script language="javascript" type="text/javascript">
    location.href="index_anadir_sectores.jsp";
</script>