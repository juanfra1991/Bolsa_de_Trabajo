...
<title>Home Lista Ofertas</title>
</head>
<body>
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	<a class="navbar-brand" href="index_lista_ofertas.jsp">Bolsa de Trabajo</a>
...
<div class="container">
	<div class="row">
        ...
        <div class="col-md-6">
            <h2 class="text-center">Lista Ofertas</h2>
            <hr>
        </div>
    </div>
<%
...
StringBuffer built_stmt1=new StringBuffer();
{
    ...
    sentencia_sql=sentencia.executeQuery("select * from v_ofertas");
    ...
    out.println("<div class='table-responsive'>");
		out.println("<table id='dataTable' class='table table-hover'>");
	        ...
	        sentencia_sql1=sentencia1.executeQuery("select * from usuario where email='"+sentencia_sql.getString(5)+"'");
		        if (sentencia_sql1.next()) {
		        	out.println("<tr>");
		                out.println("<td>"+sentencia_sql.getString(1)+"</td>");
		                out.println("<td>"+sentencia_sql.getString(2)+"</td>");
		                out.println("<td>"+sentencia_sql.getString(4).substring(0, 19)+"</td>");
		                out.println("<td>"+sentencia_sql.getString(8)+"</td>");
		                out.println("<td>"+sentencia_sql1.getString(1)+"</td>");
	            	out.println("</tr>");
		        }
		    }
     	out.println("</tbody>");
