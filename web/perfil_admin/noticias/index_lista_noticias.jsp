...
<title>Home Lista Noticias</title>
</head>
<body>
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="index_lista_noticias.jsp">Bolsa de Trabajo</a>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            <h2 class="text-center">Lista Noticias</h2>
            <hr>
        </div>
    </div>
<%
...
StringBuffer built_stmt1=new StringBuffer(); 
{
    ...
    sentencia_sql=sentencia.executeQuery("select * from noticia"); 
