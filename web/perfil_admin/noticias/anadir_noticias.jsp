...
{    
    try {
        ...
        built_stmt1.append("select * from noticia where cod_noticia='+cod_noticia'");
        sentencia_sql= sentencia1.executeQuery(built_stmt1.toString());
        if (!sentencia_sql.next()) {       
            sentencia=conexion.createStatement();
            built_stmt.append("insert into noticia values ('"+cod_noticia+"','"+titulo+"','"+descripcion+"',NOW(),'"+email+"')");
...
<script language="javascript" type="text/javascript">
    location.href="index_anadir_noticias.jsp";
</script>