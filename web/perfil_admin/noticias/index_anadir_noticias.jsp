...
<title>Home Añadir Noticias</title>

<script type="text/javascript">  
function Valida(form) { 
    if (form.noticia_valida.value == 'ok') {
        return true;
    } 
    else {
...
var no_vacio = document.forms["form"]["cod_noticia"].value;
    if (no_vacio == "") {
        if ($(".mensaje").hasClass('alert-success') || $(".mensaje").hasClass('alert-danger')) {
            $(".mensaje").removeClass('alert-success');
            $(".mensaje").removeClass('alert-danger');
        }
        $(".mensaje").addClass('alert-warning').toggleClass('hide').addClass('show').html("<button type='button' class='close' data-dismiss='alert'>&times;</button><strong>Aviso!</strong> El campo 'Código Noticia' no puede estar vacío");
        return false;
    }
peticion_http = inicializa_xhr();
    if (peticion_http) {
        peticion_http.onreadystatechange = procesaRespuesta;
        peticion_http.open("POST", "check_noticia.jsp", true);
        peticion_http.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        peticion_http.send("cod_noticia="+cod_noticia);
    }
}
    ...
    if (peticion_http.readyState == READY_STATE_COMPLETE) {
        if (peticion_http.status == 200) {
            ...
            if (estado_respuesta=="Si") {
                ...
                $(".mensaje").addClass('alert-success').toggleClass('hide').addClass('show').html("<button type='button' class='close' data-dismiss='alert'>&times;</button><strong>Aviso!</strong> El Código Noticia '"+cod_noticia+"' está disponible");
                    document.getElementById("noticia_valida").value="ok";
            }
            else {
            ...
            $(".mensaje").addClass('alert-danger').toggleClass('hide').addClass('show').html("<button type='button' class='close' data-dismiss='alert'>&times;</button><strong>Aviso!</strong> El Código Noticia '"+cod_noticia+"' no está disponible");
                document.getElementById("noticia_valida").value="no_ok";
            }
        }
    }
}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="index_anadir_noticias.jsp">Bolsa de Trabajo</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <!-- Dropdown -->
            ...
            <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle active" href="#" id="navbardrop" data-toggle="dropdown">Noticias </a>
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="index_lista_noticias.jsp">Lista Noticias</a>
                    <a class="dropdown-item" href="index_anadir_noticias.jsp">Añadir Noticias</a>
                </div>
            </li>
            <li class="nav-item dropdown">
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            <h2 class="text-center">Añadir Noticias</h2>
            <hr>
        </div>
    </div>
    <form class="form-horizontal" name="form" id="fom" role="form" method="POST" action="anadir_noticias.jsp" onSubmit="return Valida(this);">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="text" name="cod_noticia" class="form-control" id="cod_noticia" placeholder="Código Noticia *" required autofocus>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <textarea class="form-control" name="descripcion" cols="4" rows="8" placeholder="Descripcion"></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div align='center' style='padding-top: 1rem'>
            <input type="hidden" name="noticia_valida" id="noticia_valida" value="no_ok">
