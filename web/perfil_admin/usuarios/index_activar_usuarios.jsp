...
<title>Home Activar Usuarios</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	<a class="navbar-brand" href="index_activar_usuarios.jsp">Bolsa de Trabajo</a>
...
<div class="container">
	<div class="row">
        ...
        <div class="col-md-6">
            <h2 class="text-center">Activar Usuarios</h2>
            <hr>
        </div>
    </div>
<%
...
try {
    ...
    sentencia_sql=sentencia.executeQuery("select * from usuario where activo='0'");            
    // Bucle para recorrer el resultado del select
	out.println("<form action='activar_usuarios.jsp' onsubmit='return comprobar();'>");
    	...
    	out.println("</div>");
			...
			out.println("<div class='col-md-6'>");
	            out.println("<button type='submit' class='btn btn-primary'><i class='fa fa-user-plus'></i> Activar</button>");
            out.println("</div>");
        out.println("</div>");
