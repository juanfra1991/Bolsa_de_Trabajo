...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	<a class="navbar-brand" href="index_enviar_email_usuarios.jsp">Bolsa de Trabajo</a>
...
try {
    ...
    sentencia_sql=sentencia.executeQuery("select * from usuario where perfil !='1'");            
    // Bucle para recorrer el resultado del select
%>
<form class="form-horizontal" enctype="multipart/form-data" name="form" role="form" method="POST" action="enviar_email_usuarios.jsp" onSubmit="return comprobar();">
<%
    ...
    while (sentencia_sql.next()) {
        out.println("<tr>");
            out.println("<td>");
                ...
                out.println("<input type='checkbox' name='codigo' autocomplete='off' value='"+sentencia_sql.getString(1)+"'>");
                out.println("</label>");
                out.println("</div>");
            out.println("</td>");
...
%>
    ...
    <div align='center' style='padding-top: 1rem'>
		<div class='alert alert-warning alert-dismissible fade hide mensaje'>
			...
			<strong>Aviso!</strong> No has seleccionado ningún usuario
		</div>
	</div>
</form>
</div>
