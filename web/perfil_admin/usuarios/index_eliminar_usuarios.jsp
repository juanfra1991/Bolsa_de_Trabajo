...
<title>Home Eliminar Usuarios</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	<a class="navbar-brand" href="index_eliminar_usuarios.jsp">Bolsa de Trabajo</a>
...
try {
	...
	out.println("<form action='eliminar_usuarios.jsp' onsubmit='return comprobar();'>");
		...
		out.println("<div class='row' align='center' style='padding-top: 1rem'>");
			...
			out.println("<div class='col-md-6'>");
	            out.println("<button type='submit' class='btn btn-danger'><i class='fa fa-trash'></i> Eliminar</button>");
            out.println("</div>");
        out.println("</div>");
