...
<title>Home Buscar Ofertas</title>
</head>
<body>
<nav class="navbar navbar-expand-lg navbar-dark bg-info text-white">
    <a class="navbar-brand" href="index_buscar_ofertas.jsp">Bolsa de Trabajo</a>
...
<div class="container">
    <form class="form-horizontal" name="form" role="form">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2 class="text-center">Buscar Ofertas</h2>
                <hr>
            </div>
        </div>
        <div class="row">
                        ...
                        <table id="tabla" class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr style="display: none;">
                                    ...
                                    <td title="titulo"><%=sentencia_sql.getString(4)%></td>
                                    <td title="titulo"><%=sentencia_sql.getString(8)%></td>
                                </tr>
                                <% } %>
                            </tbody>
                        </table>
